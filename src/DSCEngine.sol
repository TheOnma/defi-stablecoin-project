...
contract DSCEngine is ReentrancyGuard {
    ...
    error DSC__BreaksHealthFactor(uint256 healthFactor);
    ...
    function depositCollateral(address tokenCollateralAddress, uint256 amountCollateral)
        ...
        nonReentrant
    {
        // Check if the user has already deposited collateral
    ...
    * @notice: This function working assumes that the protocol will be roughly 200% overcollateralized in order for this
    to work.
    * @notice: A known bug would be if the protocol was only 100% collateralized or less, we wouldn't be able to incentivize the liquidators.
    ...
    /* 
     * @dev Low-level internal function, don't call unless the function calling it is checking for health factors being broken
     */
